...
<body>
<div class="container">
    <h1>Alter Student Council Election</h1>
    <div class="card">
        <div class="card-body">
            <form action="altStudentCouncilAction">
                ...
                <div class="form-group row">
                    <label for="newElectionName" class="col-sm-2 col-form-label">Election Title</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="title"
                               placeholder="Enter new election title">
                    </div>
                </div>
