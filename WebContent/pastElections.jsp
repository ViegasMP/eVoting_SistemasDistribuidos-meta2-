...
<body>
<div class="container">
    <h1>Consult Past Elections</h1>
    <div class="card">
        <form action="pastElectionsAction">
            <div class="form-group row">
                <label for="electionLabel" class="col-sm-2 col-form-label">Election</label>
                <div class="col-sm-7">
                    <select name="election" >
                        <c:forEach items="${votingBean.pastElections}" var="value">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <s:textarea  style="width: 300px; height: 200px;" value="%{local}" disabled="true"/>
                </div>
            </div>
        </form>
    </div>
